class LabelFile:
    ''' This class represents label file name '''
    slice_num_index_from_right = 1
    ...
    def parseFileName(self):
        self.sub_folder_path = self.folder_path.split('\\')[-1]
        ...
        slice_num_pos = array_len - LabelFile.slice_num_index_from_right
